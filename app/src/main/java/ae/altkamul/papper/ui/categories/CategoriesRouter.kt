...
import ae.altkamul.papper.model.data.TutorialId
import ae.altkamul.papper.ui.tutorials.TutorialActivity
import ae.altkamul.papper.ui.tutorials.autonomousabilities.AutonomousAbilitiesTutorialActivity
import ae.altkamul.papper.ui.tutorials.conversation.bookmarks.BookmarksTutorialActivity
import ae.altkamul.papper.ui.tutorials.conversation.chatlocale.ChatLocaleTutorialActivity
import ae.altkamul.papper.ui.tutorials.conversation.dynamicconcepts.DynamicConceptsTutorialActivity
import ae.altkamul.papper.ui.tutorials.conversation.execute.ExecuteTutorialActivity
import ae.altkamul.papper.ui.tutorials.conversation.listen.ListenTutorialActivity
import ae.altkamul.papper.ui.tutorials.conversation.qichatbot.QiChatbotTutorialActivity
import ae.altkamul.papper.ui.tutorials.conversation.qichatvariables.QiChatVariablesTutorialActivity
import ae.altkamul.papper.ui.tutorials.gettingstarted.HelloHumanTutorialActivity
import ae.altkamul.papper.ui.tutorials.motion.animate.AnimateTutorialActivity
import ae.altkamul.papper.ui.tutorials.motion.animationlabels.AnimationLabelActivity
import ae.altkamul.papper.ui.tutorials.motion.attachedframes.FollowHumanTutorialActivity
import ae.altkamul.papper.ui.tutorials.motion.enforcetabletreachability.EnforceTabletReachabilityTutorialActivity
import ae.altkamul.papper.ui.tutorials.motion.freeframes.GoToWorldTutorialActivity
import ae.altkamul.papper.ui.tutorials.motion.gotoframe.GoToTutorialActivity
import ae.altkamul.papper.ui.tutorials.motion.lookat.LookAtTutorialActivity
import ae.altkamul.papper.ui.tutorials.motion.trajectory.TrajectoryTutorialActivity
import ae.altkamul.papper.ui.tutorials.perceptions.detecthumanswithlocalization.DetectHumansWithLocalizationTutorialActivity
import ae.altkamul.papper.ui.tutorials.perceptions.emotiondetection.EmotionTutorialActivity
import ae.altkamul.papper.ui.tutorials.motion.extendmap.MapExtensionTutorialActivity
import ae.altkamul.papper.ui.tutorials.perceptions.humanawareness.PeopleCharacteristicsTutorialActivity
import ae.altkamul.papper.ui.tutorials.perceptions.takepicture.TakePictureTutorialActivity
import ae.altkamul.papper.ui.tutorials.perceptions.touch.TouchTutorialActivity
